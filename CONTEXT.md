...
**LCD Selection**:
The currently highlighted actionable row inside the LCD that can be moved with Device Controls and activated with A/Enter.
_Avoid_: Browser focus, hover state, route state
